...
namespace ParticleSharp.Models
{
    ...
    public static class DimensionPropertyExtensions
    {
        ...
        internal static void ProcessEntanglements(this DimensionProperty entity, float stepSize, DimensionProperty item2, DimensionProperty item3, Vector3 target, bool isSeeking = false)
        {
